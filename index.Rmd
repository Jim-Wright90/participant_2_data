---
title: "Dissertation Participant 2"
output:
  html_document:
    toc: true
    toc_float: true
...
brief_parent <- import(here("data", "GASY_brief_parent.xlsx"),
               setclass = "tbl_df") 
 
brief_self <- import(here("data", "GASY_brief_self.xlsx"),
               setclass = "tbl_df") 

class_self_1 <- import(here("data", "GASY_class_self_1.xlsx"),
               setclass = "tbl_df") 

class_self_2 <- import(here("data", "GASY_class_self_2.xlsx"),
               setclass = "tbl_df") 

class_parent_1 <- import(here("data", "GASY_class_parent_1.xlsx"),
               setclass = "tbl_df") 

class_parent_2 <- import(here("data", "GASY_class_parent_2.xlsx"),
               setclass = "tbl_df") 

pcss <- import(here("data", "GASY_pcss.xlsx"),
               setclass = "tbl_df") 

status <- import(here("data", "GASY_status_goal.xlsx"),
               setclass = "tbl_df") 

status_all <- import(here("data", "GASY_status_all.xlsx"),
               setclass = "tbl_df") 

gas <- import(here("data", "GASY_gas.xlsx"),
               setclass = "tbl_df") 

demo <- import(here("data", "GASY_demo.xlsx"),
               setclass = "tbl_df")

strategy <- import(here("data", "GASY_strategy.xlsx"),
                   setclass = "tbl_df")

tarf <- import(here("data", "GASY_TARF.xlsx"),
                   setclass = "tbl_df")
```
...
freq_plot <- ggplot(strategy, aes(session, freq)) +
  ...
  theme(plot.title = element_text(color = "black", face = "bold", hjust = 0.5)) +
  labs(x = "Session",
       y = "Number of Reminders",
       title = "Weekly Number of Study Reminders Adhered To") 
...
help_plot <- ggplot(strategy, aes(session, help)) +
  ...
  labs(x = "Session",
       ...
       title = "Perceived Helpfulness of Study Reminders",
...
freq_plot2 <- ggplot(strategy, aes(session, freq_2)) +
  geom_line() +
  geom_point(size = 2) +
  ...
  labs(x = "Session",
       ...
       title = "Weekly Number of Study Sessions with Accountability Partner") 
  
freq_plot2

help_plot2 <- ggplot(strategy, aes(session, help_2)) +
  geom_line() +
  geom_point(size = 2) +
  scale_x_continuous(limits = c(12, 13),
                     breaks = c(12, 13)) +
  ...
  labs(x = "Session",
       y = "Level of Helpfulness",
       title = "Perceived Helpfulness of Accountability Partner",
       caption = "1 = Not Helpful at All\n 2 = Not Helpful\n 3 = Somewhat Helpful\n 4 = Helpful\n 5 = Very Helpful") 
